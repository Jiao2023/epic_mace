...
from chempropfix.constants import TEST_SCORES_FILE_NAME, TRAIN_LOGGER_NAME
from chempropfix.data import get_data, get_task_names, MoleculeDataset, validate_dataset_type
from chempropfix.utils import create_logger, makedirs, timeit, multitask_mean
from chempropfix.features import set_extra_atom_fdim, set_extra_bond_fdim, set_explicit_h, set_adding_hs,set_reaction, reset_featurization_parameters
from chempropfix.features import set_keeping_atom_map
import pdb
...
def cross_validate(args: TrainArgs,
    ...
    set_explicit_h(args.explicit_h) #false
    set_adding_hs(args.adding_h) #false
    set_keeping_atom_map(args.keeping_atom_map) #false
